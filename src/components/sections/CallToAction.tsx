        ...
        <div className="flex w-[605px] max-w-full flex-col items-center relative z-10">
          ...
          >
            <motion.span
              ...
              animate={{ 
                color: ["rgba(204,204,204,1)", "rgba(235,235,235,1)", "rgba(204,204,204,1)"]
              }}
          ...
          >
            <motion.span
              initial={{ color: "rgba(204,204,204,1)" }}
              animate={{ 
                color: ["rgba(204,204,204,1)", "rgba(208,255,0,0.9)", "rgba(204,204,204,1)"]
              }}
          ...
          >
            ...
            >
              ...
              <div className="flex w-full max-w-md mx-auto">
                ...
                />
                <button 
                  className="bg-[rgba(208,255,0,0.9)] hover:bg-[rgba(208,255,0,1)] text-[rgba(13,13,13,1)] font-medium py-3 px-6 rounded-r-md transition-colors"
                >
                  Subscribe
                </button>
              </div>
          ...
          >
            ...
            >
              ...
              >
                <svg width="12" height="12" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M20 6L9 17L4 12" stroke="rgba(13,13,13,1)" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </motion.div>
              <span className="text-[rgba(180,180,180,1)] text-sm">Free Consultation</span>
            </motion.div>
            ...
            >
              ...
              <span className="text-[rgba(180,180,180,1)] text-sm">Personalized Design</span>
            </motion.div>
            ...
            >
              ...
              <span className="text-[rgba(180,180,180,1)] text-sm">Premium Support</span>
            </motion.div>
          </motion.div>
