    ...
    >
      ...
      >
        ...
        <div className="flex justify-center mb-10 max-md:hidden">
          <motion.div className="w-[33%]" variants={topCardVariants}>
            <motion.div
            ...
            >
              <motion.div className="border-neutral-800 border w-full pl-[15px] pr-[45px] pt-[17px] pb-[120px] rounded-[30px] border-solid max-md:pr-5 max-md:pb-[100px] relative">
                <motion.div
                ...
                >
                  We prioritize high-quality, durable solutions that our
                  customers can depend on for seamless automation.
                </motion.p>
              </motion.div>
            </motion.div>
          </motion.div>
        ...
        <div className="gap-5 flex max-md:flex-col max-md:items-stretch">
          ...
          >
            <div className="flex w-full flex-col items-stretch font-normal tracking-[-0.18px] max-md:mt-10">
              ...
              <motion.div
                ...
                animate={isVisible ? "rest" : "hidden"}
              >
                <motion.div className="border-neutral-800 border w-full pl-[15px] pr-[42px] pt-3.5 pb-[146px] rounded-[30px] border-solid max-md:pr-5 max-md:pb-[100px] relative">
                  <motion.div
                    className="absolute inset-0 bg-gradient-to-br from-[rgba(30,30,30,0.2)] to-transparent opacity-0"
                    whileHover={{ opacity: 1 }}
                    transition={{ duration: 0.5 }}
          ...
          >
            <motion.div
              ...
              animate={isVisible ? "rest" : "hidden"}
            >
              <motion.div className="border-neutral-800 border w-full pl-[15px] pr-[42px] pt-3.5 pb-[120px] rounded-[30px] border-solid max-md:pr-5 max-md:pb-[100px] relative">
                <motion.div
                  className="absolute inset-0 bg-gradient-to-br from-[rgba(30,30,30,0.2)] to-transparent opacity-0"
                  whileHover={{ opacity: 1 }}
                  transition={{ duration: 0.5 }}
          ...
          >
            <motion.div
              ...
              animate={isVisible ? "rest" : "hidden"}
            >
              <motion.div className="border-neutral-800 border w-full pl-[15px] pr-[45px] pt-5 pb-[137px] rounded-[30px] border-solid max-md:pr-5 max-md:pb-[100px] relative">
                <motion.div
                  className="absolute inset-0 bg-gradient-to-br from-[rgba(30,30,30,0.2)] to-transparent opacity-0"
                  whileHover={{ opacity: 1 }}
                  transition={{ duration: 0.5 }}
