...
const Header = () => {
  ...
  return (
    <header className="relative flex justify-between bg-black items-center px-12 py-6 max-md:px-8 max-sm:px-5">
      ...
      {/* Mobile Menu Button */}
      <div className="hidden max-md:block cursor-pointer z-20" onClick={toggleMobileMenu}>
        <div
      ...
      {/* Mobile Menu Overlay */}
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-10 hidden max-md:flex flex-col items-center justify-center bg-black bg-opacity-95">
